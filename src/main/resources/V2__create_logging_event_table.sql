-- Create sequence for logging_event table if it doesn't exist
CREATE SEQUENCE IF NOT EXISTS logging_event_id_seq;

-- Logback's default table structure for DBAppender
